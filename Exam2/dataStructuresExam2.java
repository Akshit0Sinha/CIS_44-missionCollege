...
public class dataStructuresExam2 {
	// ==========================================
	// 3. TREES
	// ==========================================
	...
	public static void bubbleSort(int[] arr) {
		...
		/**
		 * TODO: Return the total count of nodes in the binary tree. Hint: Use recursion
		...
		// ==========================================
		/**
		 * TODO: Find and return the maximum value in an array. Constraint: Try to do
		...
		// ==========================================
		/**
		 * TODO: Implement Linear Search. Return the index of the target if found,
		 * otherwise return -1.
		 */
		...
		// ==========================================
		/**
		 * TODO: Calculate the sum of all integers from 1 to n recursively. Example:
		 * sum(5) -> 5 + 4 + 3 + 2 + 1 = 15
		 */
